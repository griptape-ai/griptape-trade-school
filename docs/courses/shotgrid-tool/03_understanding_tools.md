...
--8<-- "docs/courses/shotgrid-tool/assets/code_reviews/03/app.py"
```

---
## Next Steps
You have access to DateTimeTool (not quite as cool as SpaceTime, but still..). In the [next section](04_first_tool.md), you will build your first Griptape Tool.
