...
<iframe width="560" height="315" src="https://www.youtube.com/embed/_rg5rbzNc4c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
There are multiple ways communicate with LLMs via Griptape, but the one we'll use in this example is an **Agent**. You can learn more about Agents in [this course](../../agents/index.md) or in the [documentation](https://docs.griptape.ai/en/latest/griptape-framework/structures/agents/), but here's a simple way to understand them:
